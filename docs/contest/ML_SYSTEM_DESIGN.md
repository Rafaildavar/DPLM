...
|---|---|---|---|
| Static gesture recognition | Stable | H-105 grouped 5-fold CV: production craft ExtraTrees accuracy `0.7767`, macro F1 `0.6613`; all positive static classes F1 `1.0` | fresh live positive/no-command matrix |
