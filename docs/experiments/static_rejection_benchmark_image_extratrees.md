...
| `one_vs_rest_logreg` | ok | 0.9962 | 0.9938 | 0.0063 | 1.0000 | 0.0000 | 1.0000 | 0.6115 | 0 |
| `confidence_threshold` | ok | 0.9769 | 0.9625 | 0.0375 | 1.0000 | 0.0000 | 1.0000 | 0.5923 | 0 |
| `isolation_forest` | ok | 0.9077 | 0.8500 | 0.1500 | 1.0000 | 0.0000 | 1.0000 | 0.5231 | 0 |
| `local_outlier_factor` | ok | 0.8692 | 0.7875 | 0.2125 | 1.0000 | 0.0000 | 1.0000 | 0.4846 | 0 |
...
- reject reasons: `{"low_confidence": 6, "negative_class": 100}`
- false positive predictions: `{}`
...
### `one_vs_rest_logreg`
- reject reasons: `{"negative_class": 100, "verifier_rejected": 1}`
- false positive predictions: `{}`

### `local_outlier_factor`
- reject reasons: `{"local_outlier_factor_outlier": 34, "negative_class": 100}`
- false positive predictions: `{}`

### `isolation_forest`
- reject reasons: `{"isolation_forest_outlier": 24, "negative_class": 100}`
- false positive predictions: `{}`
