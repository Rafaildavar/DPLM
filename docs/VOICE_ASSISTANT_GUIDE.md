# Руководство по голосовому помощнику DPLM
...
Голосовой помощник DPLM — полнофункциональный ассистент с базовым функционалом современных голосовых помощников (Siri, Google Assistant, Alexa).
...
- **Выполнение команд**: Интеграция с системой команд DPLM
